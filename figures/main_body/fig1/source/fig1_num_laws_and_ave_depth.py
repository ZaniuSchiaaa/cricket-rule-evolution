...
Outputs
-------
    figures/main_body/fig1/components/fig1_num_laws_and_ave_depth.svg
"""
...
# ---------------------------------------------------------------------------
YAML_DIR = (
    "./data/datasets/rule_set_structure/yaml_files"
)
FIGURES_DIR = (
    "./figures/main_body/fig1/components"
)
...
def build_dataframe(tree_type: str) -> pd.DataFrame:
    """
    Walk the YAML files and
    return a DataFrame with columns ['Number of Laws', 'Average Depth'],
    indexed by Year.
    """
    subtree_path = os.path.join(YAML_DIR, tree_type)
