...
Generates radial network visualizations of the 2019 cricket ruleset YAML tree,
colored by node depth.

Usage
-----
    # From the repo root:
    python figures/main_body/fig6/source/fig6_a_2019_tree_structure.py
"""
...
PNG_PATH_TEMPLATE = (
    "./figures/main_body/fig6/components/fig6_a_2019_tree_structure.png"
)
...
def process_year(year: int) -> None:
    ...
    for spine in ax.spines.values():
        spine.set_linewidth(2)        # increase for a thicker box
