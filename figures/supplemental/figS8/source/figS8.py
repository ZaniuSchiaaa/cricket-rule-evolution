...
Generates the first depth-distribution grid (6x4, first 24 edition years) for the
...
-----
    # From the repo root:
    python figures/supplemental/figS8/source/figS8.py

Outputs
-------
    ./figures/supplemental/figS8/fig8_final.svg
...
OUTPUT_DIR = "./figures/supplemental/figS8"
...
if not yaml_files:
    ...
    # ──────────────────────────────────────────────────────────────────────────
    # [5] GRID PLOT (6x4, first 24)
    # ──────────────────────────────────────────────────────────────────────────
    mode_suffix = "leaves" if LEAVES_ONLY else "all-nodes"
    batch = all_data[:24]
    filename = f"figS8_final.svg"
