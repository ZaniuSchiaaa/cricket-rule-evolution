...
Generates the first Zipf-Mandelbrot fit grid (5x4, last 20 edition years) for the
...
-----
    # From the repo root:
    python figures/supplemental/figS5/source/figS5.py

Outputs
-------
    ./figures/supplemental/figS5/figS5_final.svg
"""
...
OUTPUT_DIR = "./figures/supplemental/figS5"
...
plt.tight_layout()
out_path = os.path.join(OUTPUT_DIR, "figS5_final.svg")
