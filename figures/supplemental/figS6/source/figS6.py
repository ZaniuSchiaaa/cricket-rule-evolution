...
Generates a 6x4 grid of radial network visualizations of the cricket ruleset
YAML trees (first 24 edition years, 1752-1908), colored by node depth, with a
shared depth colorbar.

Usage
-----
    # From the repo root:
    python figures/supplemental/figS6/source/figS6.py

Outputs
-------
    ./figures/supplemental/figS6/figS6_final.png
"""
...
OUTPUT_DIR = "./figures/supplemental/figS6"
OUTPUT_NAME = "figS6_final.png"

TARGET_YEARS = [
    1752, 1755, 1774, 1785, 1786, 1788, 1803, 1806, 1809,
    1816, 1820, 1823, 1828, 1830, 1835, 1857, 1884, 1890,
    1892, 1896, 1900, 1902, 1906, 1908,
]
